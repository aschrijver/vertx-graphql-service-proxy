...
public class GraphQLInputObjectFieldDO extends GraphQLInputObjectField
    ...
    private GraphQLInputObjectFieldDO(GraphQLInputObjectField field, JsonObject fieldJson,
        ...
        super(EMPTY, null, new GraphQLEnumType(EMPTY, null, Collections.emptyList()), null);
        this.field = field;
    ...
    public JsonObject toJson() {
        ...
        return JsonObjectHelper.jsonObject()
                .put(MARSHALED_TYPE, GraphQLInputObjectField.class.getName())
                .put(NAME, getName())
    ...
    public String getName() {
        if (field == null) {
            return fieldJson.getString(NAME);
        }
    ...
    public GraphQLInputType getType() {
        if (field == null) {
            return context.unmarshall(fieldJson.getJsonObject(TYPE));
        }
    ...
    public Object getDefaultValue() {
        if (field == null) {
            return fieldJson.getValue(DEFAULT_VALUE);
        }
    ...
    public String getDescription() {
        if (field == null) {
            return fieldJson.getString(DESCRIPTION);
        }
