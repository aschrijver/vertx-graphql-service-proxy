...
public class GraphQLNonNullDO extends GraphQLNonNull
    ...
    public JsonObject toJson() {
        ...
        return new JsonObject()
                .put(MARSHALED_TYPE, GraphQLNonNull.class.getName())
                .put(WRAPPED_TYPE, context.referenceTo(getWrappedType()));
    }
    ...
    public GraphQLType getWrappedType() {
        if (typeNonNull == null) {
            return context.unmarshall(typeNonNullJson.getJsonObject(WRAPPED_TYPE));
        }
    ...
    public String getName() {
        if (typeNonNull == null) {
            return typeNonNullJson.getString(NAME);
        }
