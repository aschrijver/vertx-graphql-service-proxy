...
public class GraphQLEnumTypeDO extends GraphQLEnumType implements SchemaDecorator<GraphQLEnumType> {
    ...
    private GraphQLEnumTypeDO(GraphQLEnumType enumType, JsonObject enumTypeJson, SchemaContext context) {
        super(EMPTY, null, Collections.emptyList());
    ...
    public JsonObject toJson() {
        ...
        return JsonObjectHelper.jsonObject()
                .put(MARSHALED_TYPE, GraphQLEnumType.class.getName())
                .put(NAME, getName())
                .putIfPresent(DESCRIPTION, getDescription())
                .put(VALUES, getValues().stream()
    ...
    public List<GraphQLEnumValueDefinition> getValues() {
        if (enumType == null) {
            return context.unmarshallList(enumTypeJson, VALUES, this);
        }
    ...
    public String getName() {
        if (enumType == null) {
            return enumTypeJson.getString(NAME);
        }
    ...
    public String getDescription() {
        if (enumType == null) {
            return enumTypeJson.getString(DESCRIPTION);
        }
