...
public class GraphQLInputObjectTypeDO extends GraphQLInputObjectType
    ...
    public JsonObject toJson() {
        ...
        return JsonObjectHelper.jsonObject()
                .put(MARSHALED_TYPE, GraphQLInputObjectType.class.getName())
                .put(NAME, getName())
                .putIfPresent(DESCRIPTION, getDescription())
                .put(FIELDS, getFields().stream()
    ...
    public List<GraphQLInputObjectField> getFields() {
        if (type == null) {
            return context.unmarshallList(typeJson, FIELDS, this);
        }
    ...
    public GraphQLInputObjectField getField(String name) {
        if (type == null) {
            return (GraphQLInputObjectField) context.unmarshall(
                    typeJson.getJsonObject(FIELDS, new JsonObject()).getJsonObject(name), this);
        }
