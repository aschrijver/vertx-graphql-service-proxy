...
public class GraphQLEnumValueDefinitionDO extends GraphQLEnumValueDefinition
    ...
    public JsonObject toJson() {
        ...
        return JsonObjectHelper.jsonObject()
                .put(PropNames.MARSHALED_TYPE, GraphQLEnumValueDefinition.class.getName())
                .put(PropNames.NAME, getName())
                .putIfPresent(PropNames.DESCRIPTION, getDescription())
                .put(PropNames.VALUE, getValue())
                .putIfPresent(PropNames.DEPRECATION_REASON, getDeprecationReason());
    }
    ...
    public String getName() {
        if (definition == null) {
            return definitionJson.getString(PropNames.NAME);
        }
    ...
    public String getDescription() {
        if (definition == null) {
            return definitionJson.getString(PropNames.DESCRIPTION);
        }
    ...
    public Object getValue() {
        if (definition == null) {
            return definitionJson.getValue(PropNames.VALUE);
        }
    ...
    public String getDeprecationReason() {
        if (definition == null) {
            return definitionJson.getString(PropNames.DEPRECATION_REASON);
        }
